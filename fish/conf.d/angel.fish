...
set -gx FZF_DEFAULT_OPTS "--height 60% --popup center,60%,40%"
...
alias lsa='eza -1 -a --icons=auto --sort=name --group-directories-first'
alias g='git'
...
# alias pkgls='apk list |grep installed'
# alias pkginf='apk info'
# alias pkgq='apk query'
alias emerge-in='sudo emerge -a --quiet-build'
alias emerge-world='sudo emerge -avuDN @world'
# fastfetch logo
alias fetch='clear && pokeget random --hide-name | fastfetch --file-raw -'
abbr mkdir 'mkdir -p'

function fish_greeting
    echo (set_color purple)Hii Fagg- I-I mean uhh... (set_color red)$USER~(set_color purple)!
    echo (set_color purple)Welcome to $hostname '<3'
    echo ' '
